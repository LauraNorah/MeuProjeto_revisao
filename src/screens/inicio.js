...
export default function Inicio() {
  return (
    <View style={styles.container}>
      ...
      <Text  style={{ fontSize: 40, fontWeight: 'bold', marginTop: 40}} > Ótimo dia!</Text>
      <Text style={{ fontSize: 15, fontWeight: 'bold', marginTop: 10, marginBottom: 40}} >Como deseja acessar?</Text>
      ...
      <TouchableOpacity 
        ...
        onPress={() => console.log('Você acessou.')}
      >
        <Image
      ...
      <TouchableOpacity 
        ...
        onPress={() => console.log('outras opções.')}>
